...
class ModuleExamples {
    ...
    async run(argv, methodName = "", waitForConfirmation = false) {
        if (methodName.toLowerCase() == "findOneById".toLowerCase() || methodName == "") {
            const moduleId = argv === "" ? "0xf75be6f9418710fd516fa82afb3aad07e11a0f1b" : argv;
        ...
        if (methodName.toLowerCase() == "simulateRunModules".toLowerCase() || methodName == "") {
            ...
            const value = params?.value ? params.value : 1;
            console.log(await this.veraxSdk.module.simulateRunModules(modulesAddresses, attestationPayload, validationPayloads, value));
        }
        if (methodName.toLowerCase() == "runModules".toLowerCase() || methodName == "") {
            ...
            const validationPayloads = params?.validationPayloads ?? [];
            const value = params?.value ? params.value : 1;
            console.log(await this.veraxSdk.module.runModules(modulesAddresses, attestationPayload, validationPayloads, value, waitForConfirmation));
        }
        if (methodName.toLowerCase() == "simulateBulkRunModules".toLowerCase() || methodName == "") {
            ...
            const validationPayloads = params?.validationPayloads ?? [[""], [""]];
            console.log(await this.veraxSdk.module.simulateBulkRunModules(modulesAddresses, attestationPayloads, validationPayloads));
        }
        if (methodName.toLowerCase() == "bulkRunModules".toLowerCase() || methodName == "") {
            ...
            const validationPayloads = params?.validationPayloads ?? [[""], [""]];
            console.log(await this.veraxSdk.module.bulkRunModules(modulesAddresses, attestationPayloads, validationPayloads, waitForConfirmation));
        }
        if (methodName.toLowerCase() == "isContractAddress".toLowerCase() || methodName == "") {
            const contractAddress = argv === "" ? "0x8DcC1F7e746D6071Eb3ee9012aFB6c707bFf82a5" : argv;
        ...
        if (methodName.toLowerCase() == "isRegistered".toLowerCase() || methodName == "") {
            const moduleAddress = argv === "" ? "0x8DcC1F7e746D6071Eb3ee9012aFB6c707bFf82a5" : argv;
...
exports.default = ModuleExamples;
//# sourceMappingURL=moduleExamples.js.map