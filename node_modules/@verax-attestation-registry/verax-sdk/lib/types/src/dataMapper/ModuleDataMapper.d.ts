...
export default class ModuleDataMapper extends BaseDataMapper<Module, Module_filter, Module_orderBy> {
    ...
    simulateRegister(name: string, description: string, moduleAddress: Address): Promise<{
        address: `0x${string}`;
        type?: "legacy" | undefined;
        gas?: bigint | undefined;
        nonce?: number | undefined;
    ...
    simulateRunModules(modulesAddresses: Address[], attestationPayload: AttestationPayload, validationPayloads: string[], value: number): Promise<{
        address: `0x${string}`;
        type?: "legacy" | undefined;
        gas?: bigint | undefined;
        nonce?: number | undefined;
    ...
    simulateBulkRunModules(modulesAddresses: Address[], attestationPayloads: AttestationPayload[], validationPayloads: string[][]): Promise<{
        address: `0x${string}`;
        type?: "legacy" | undefined;
        gas?: bigint | undefined;
        nonce?: number | undefined;
