...
export default class AttestationDataMapper extends BaseDataMapper<Attestation, Attestation_filter, Attestation_orderBy> {
    typeName: string;
    gqlInterface: string;
    ...
    simulateUpdateRouter(routerAddress: Address): Promise<{
        address: `0x${string}`;
    ...
    simulateMassImport(portalAddress: Address, attestationPayloads: AttestationPayload[]): Promise<{
        address: `0x${string}`;
        type?: "legacy" | undefined;
        gas?: bigint | undefined;
        nonce?: number | undefined;
    ...
    massImport(portalAddress: Address, attestationPayloads: AttestationPayload[], waitForConfirmation?: boolean): Promise<Partial<import("viem").TransactionReceipt>>;
    simulateIncrementVersionNumber(): Promise<{
        address: `0x${string}`;
        type?: "legacy" | undefined;
        gas?: bigint | undefined;
        nonce?: number | undefined;
    ...
    incrementVersionNumber(waitForConfirmation?: boolean): Promise<Partial<import("viem").TransactionReceipt>>;
...
//# sourceMappingURL=AttestationDataMapper.d.ts.map