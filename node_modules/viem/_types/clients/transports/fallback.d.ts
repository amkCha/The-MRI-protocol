...
export type FallbackTransport<transports extends Transport[] = Transport[]> = Transport<'fallback', {
...
export declare function fallback<const transports extends Transport[]>(transports_: transports, config?: FallbackTransportConfig): FallbackTransport<transports>;
