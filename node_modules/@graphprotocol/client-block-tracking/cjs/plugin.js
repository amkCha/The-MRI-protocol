...
exports.useBlockTracking = void 0;
...
function useBlockTracking(configInput) {
    ...
    return {
        onSubgraphExecute({ fusiongraph, subgraphName, executionRequest, setExecutionRequest }) {
            setExecutionRequest((0, shared_js_1.transformExecutionRequest)(executionRequest, config, fusiongraph, false, minBlockMap.get(subgraphName)));
