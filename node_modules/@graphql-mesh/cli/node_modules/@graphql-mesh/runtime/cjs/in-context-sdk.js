                ...
                for (const fieldName in rootTypeFieldMap) {
                    ...
                    rawSourceContext[rootType.name][fieldName] = ({ root, args, context, info = {
                        ...
                        if (key && argsFromKeys) {
                            ...
                            const onDelegateResult$ = (0, utils_1.iterateAsync)(onDelegateHooks, onDelegateHook => onDelegateHook(onDelegatePayload), onDelegateHookDones);
...
function handleOnDelegateDone(delegationResult, onDelegateHookDones) {
    ...
    const onDelegateDoneResult$ = (0, utils_1.iterateAsync)(onDelegateHookDones, onDelegateHookDone => onDelegateHookDone({
