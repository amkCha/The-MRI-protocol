...
function getTsConfigBaseDir(baseDir) {
    ...
    return tsConfigExists ? baseDir : cross_helpers_1.process.cwd();
}
async function graphqlMesh(cliParams = exports.DEFAULT_CLI_PARAMS, args = (0, helpers_1.hideBin)(cross_helpers_1.process.argv), cwdPath = cross_helpers_1.process.cwd()) {
    ...
    return (0, yargs_1.default)(args)
        ...
        coerce: (externalModules) => Promise.all(externalModules.map(moduleName => {
            ...
            return (0, utils_1.defaultImportFn)(islocalModule ? localModulePath : moduleName);
        })),
    })
        .option('dir', {
        ...
        coerce: dir => {
            ...
            const tsConfigPath = cross_helpers_1.path.join(tsConfigBaseDir, 'tsconfig.json');
            const tsConfigExists = cross_helpers_1.fs.existsSync(tsConfigPath);
