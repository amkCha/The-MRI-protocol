 ...
 */
export declare const collectSubfields: typeof _collectSubfields;
declare function _collectSubfields(compilationContext: CompilationContext, returnType: GraphQLObjectType, fieldNodes: FieldNode[], parentResponsePath?: ObjectPath): {
