                    ...
                    for (const fieldNode of info.fieldNodes) {
                        ...
                        for (const candidate of candidatesReversed) {
                            ...
                            if (candidate.transformedSubschema) {
                                const unavailableFields = (0, delegate_1.extractUnavailableFields)(candidate.transformedSubschema.transformedSchema, typeFieldMap[candidate.fieldName], fieldNode, () => true);
            ...
            if (interfaceInSubgraph.kind === graphql_1.Kind.INTERFACE_TYPE_DEFINITION) {
                ...
                for (const definitionNode of supergraphAst.definitions) {
                    if (definitionNode.kind === graphql_1.Kind.OBJECT_TYPE_DEFINITION &&
                        ...
                        if (existingType?.kind === graphql_1.Kind.OBJECT_TYPE_DEFINITION &&
