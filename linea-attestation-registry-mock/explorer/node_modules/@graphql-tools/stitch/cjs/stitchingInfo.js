...
function createMergedTypes(typeCandidates, mergeTypes) {
    ...
    for (const typeName in typeCandidates) {
        if (typeCandidates[typeName].length > 1 &&
            ((0, graphql_1.isObjectType)(typeCandidates[typeName][0].type) ||
            ...
            if (mergeTypes === true ||
                ...
                for (const typeCandidate of typeCandidates[typeName]) {
                    ...
                    const resolver = mergedTypeConfig.resolve ?? (0, createMergedTypeResolver_js_1.createMergedTypeResolver)(mergedTypeConfig);
                    if (resolver == null) {
                        continue;
                    }
