...
function wrapFetchWithPlugins(plugins) {
    ...
    return function wrappedFetchFn(url, options, context, info) {
        ...
        const result$ = (0, utils_js_1.iterateAsync)(onFetchHooks, onFetch => onFetch({
            fetchFn,
            setFetchFn,
            url,
            options,
        ...
        function handleIterationResult() {
            ...
            if ((0, utils_2.isPromise)(response$)) {
...
async function getMesh(options) {
        ...
        ...(subschema
            ...
            : [
                ...
                (0, graphql_jit_1.useGraphQlJit)({
                    ...
                    enableIf(args) {
                        return !(0, utils_js_1.isStreamOperation)(args.document);
                    },
                }),
            ]),
        (0, core_1.useExtendContext)(() => {
    ...
    function createExecutor(globalContext = EMPTY_CONTEXT_VALUE) {
        ...
        return function meshExecutor(documentOrSDL, variableValues = EMPTY_VARIABLES_VALUE, contextValue = EMPTY_CONTEXT_VALUE, rootValue = EMPTY_ROOT_VALUE, operationName) {
            ...
            if ((0, utils_2.isPromise)(contextValue$)) {
                return contextValue$.then(contextValue => executeFn({
                    schema,
                    document,
                    contextValue,
                    rootValue,
...
function handleOnFetchDone(response, onFetchDoneHooks) {
    ...
    const result$ = (0, utils_js_1.iterateAsync)(onFetchDoneHooks, onFetchDone => onFetchDone({
        response,
        setResponse,
    }));
    if ((0, utils_2.isPromise)(result$)) {
