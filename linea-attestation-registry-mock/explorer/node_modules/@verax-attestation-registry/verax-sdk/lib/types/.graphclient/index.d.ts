...
export type Attestation_orderBy = 'id' | 'schemaId' | 'replacedBy' | 'attester' | 'portal' | 'attestedDate' | 'expirationDate' | 'revocationDate' | 'version' | 'revoked' | 'subject' | 'attestationData' | 'schemaString' | 'decodedData';
...
export type Counter_orderBy = 'id' | 'attestations' | 'modules' | 'portals' | 'schemas';
export type Module = {
    id: Scalars['ID'];
...
export type Module_orderBy = 'id' | 'moduleAddress' | 'name' | 'description';
...
export type Portal_orderBy = 'id' | 'ownerAddress' | 'modules' | 'isRevocable' | 'name' | 'description' | 'ownerName';
export type Query = {
...
export type Schema_orderBy = 'id' | 'name' | 'description' | 'context' | 'schema';
