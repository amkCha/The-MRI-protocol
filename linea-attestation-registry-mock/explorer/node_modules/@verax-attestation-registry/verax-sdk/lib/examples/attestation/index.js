...
const attestationExamples_1 = __importDefault(require("./attestationExamples"));
...
new attestationExamples_1.default(veraxSdk).run(argv, process.argv[2], waitForConfirmation);
