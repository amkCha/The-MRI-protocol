...
exports.getNewBlockNumberFromExecutionResult = exports.transformExecutionRequest = exports.createMetaSelectionNode = exports.DEFAULT_CONFIG = void 0;
...
exports.createMetaSelectionNode = (0, utils_1.memoize1)(function createMetaSelectionNode(config) {
    return {
...
function transformExecutionRequest(executionRequest, config, transformedSchema, batch = false, minBlock) {
        ...
        OperationDefinition: {
            leave: (operationNode) => {
                ...
                if (operationNode.operation === graphql_1.OperationTypeNode.QUERY && shouldAddMetaField) {
                    const metaSelectionNode = (0, exports.createMetaSelectionNode)(config);
...
exports.transformExecutionRequest = transformExecutionRequest;
function getNewBlockNumberFromExecutionResult(originalResult, config) {
    return originalResult.data?.[config.metaRootFieldName]?.[config.blockFieldName]?.[config.blockNumberFieldName];
}
exports.getNewBlockNumberFromExecutionResult = getNewBlockNumberFromExecutionResult;
