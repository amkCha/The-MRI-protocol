                ...
                for (const fieldName in rootTypeFieldMap) {
                    ...
                    rawSourceContext[rootType.name][fieldName] = ({ root, args, context, info = {
                        ...
                        if (key && argsFromKeys) {
                            ...
                            const onDelegateResult$ = (0, utils_js_1.iterateAsync)(onDelegateHooks, onDelegateHook => onDelegateHook(onDelegatePayload), onDelegateHookDones);
                            if ((0, utils_2.isPromise)(onDelegateResult$)) {
                                return onDelegateResult$.then(() => handleIterationResult(batch_delegate_1.batchDelegateToSchema, batchDelegationOptions, onDelegateHookDones));
                            }
                            return handleIterationResult(batch_delegate_1.batchDelegateToSchema, batchDelegationOptions, onDelegateHookDones);
                        }
                        else {
                            ...
                            const onDelegateResult$ = (0, utils_js_1.iterateAsync)(onDelegateHooks, onDelegateHook => onDelegateHook(onDelegatePayload), onDelegateHookDones);
                            if ((0, utils_2.isPromise)(onDelegateResult$)) {
                                return onDelegateResult$.then(() => handleIterationResult(delegate_1.delegateToSchema, regularDelegateOptions, onDelegateHookDones));
                            }
                            return handleIterationResult(delegate_1.delegateToSchema, regularDelegateOptions, onDelegateHookDones);
                        }
                    };
                }
            }
...
function handleIterationResult(delegateFn, delegateOptions, onDelegateHookDones) {
    ...
    if ((0, utils_2.isPromise)(delegationResult$)) {
...
function handleOnDelegateDone(delegationResult, onDelegateHookDones) {
    ...
    const onDelegateDoneResult$ = (0, utils_js_1.iterateAsync)(onDelegateHookDones, onDelegateHookDone => onDelegateHookDone({
        result: delegationResult,
        setResult,
    }));
    if ((0, utils_2.isPromise)(onDelegateDoneResult$)) {
