...
import MRIprotocol from "@/assets/issuers/mricommittee.svg?react";
...
export const issuersData: IIssuer[] = [
  ...
  },
  {
    name: "MRI Protocol",
    logo: MRIprotocol,
    keywords: ["Proof of minority", "Client score"],
    description:
      "MRI Protocol - Minority Report Protocol. We conduct a ranking of the consensus and execution ethereum clients distribution by auditing the tags in the graffitis in order to detect who are the minority clients every quarter",
    CTALink: "https://github.com/amkCha/The-MRI-protocol",
    CTATitle: "Go To MRI protocol",
    address: "0x18cAF1E4E9c2e179678d8cc538f10298b503CCcd",
  },
  {
    name: "PADO Labs",
    logo: Pado,
